...
<body>
	...
	<div class="main-content">
		<div class="content-page">
			...
			<h3>Datos de pago</h3>
			<div class="p-line"><div>TOTAL:</div>€/.&nbsp;<span id="total"></span></div>
			<div class="p-line"><div>Banco:</div>Banco Santander</div>
			<div class="p-line"><div>N° de Cuenta:</div>191-45678945-006</div>
			<div class="p-line"><div>Representante:</div>Encargado de ventas</div>
			<p><b>NOTA:</b> Para confirmar la compra debe realizar el deposito, y enviar el comprobante al siguiente correo suli5@protonmail.com o al número de whatsapp 722 57 84 85</p>
		</div>
	</div>
